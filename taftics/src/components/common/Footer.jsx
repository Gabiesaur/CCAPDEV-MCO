      ...
      <div className="container">
        <div className="row">
          <div className="col-md-3">
            <h2 className="fw-bold" style={{ fontSize: "64px" }}>
              Taftics
            </h2>
            <p
              className="small"
            ...
            >
              Every Archer needs a strategy.
            </p>
          </div>
          <div className="col-md-3">
            <h6 className="fw-bold small opacity-50 text-uppercase">
              Quick Links
            </h6>
          ...
          <div className="col-md-3">
            ...
            <p className="small mb-1">Taftics Inc.</p>
            <p className="small mb-1">taftics@gmail.com</p>
