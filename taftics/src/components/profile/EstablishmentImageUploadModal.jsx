...
export default function EstablishmentImageUploadModal({ isOpen, onClose, onUploadSuccess, establishmentId }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (data.success) {
        onUploadSuccess(data.establishment);
        handleCloseModal();
      } else {
        ...
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content border-0 shadow-lg rounded-4 overflow-hidden bg-white">
            <div className="modal-header bg-dlsu-dark text-white border-0 py-3">
              <h5 className="modal-title fw-bold">Update Establishment Image</h5>
              <button
                type="button"
                ...
                {preview ? (
                  ...
                  <>
                    ...
                    <h6 className="fw-bold mb-1">
                      {isDragging ? "Drop your establishment cover here" : "Click or drag to upload cover image"}
                    </h6>
                    <p className="text-muted small mb-0">
                      Landscape orientation recommended (min. 1200x675)
                    </p>
                  </>
                )}
            ...
            <div className="modal-footer border-0 p-3 pt-0">
              ...
              >
                ...
                {loading ? "Saving..." : "Save Cover Image"}
              </button>
            </div>
          </div>
        </div>
