...
exports.toggleBookmark = async (req, res) => {
  try {
    ...
    const isSaved =
      user.savedEstablishments &&
      user.savedEstablishments.includes(establishmentId);
    ...
    res.json({
      ...
      savedEstablishments: user.savedEstablishments,
    });
  } catch (error) {
...
exports.getOwnedComments = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Server error while fetching user comments" });
  }
};
